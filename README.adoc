...
jobs:
  job1:
    outputs:
      ...
      gosec-job-output-policy-subject: ${{ steps.gosec-step.outputs.policy-subject }}
    steps:
      - name: check out source code
        uses: cloudbees-io/checkout@v1
        with:
    ...
    steps:
      - id: print-outputs-from-job1
        ...
        run: |
          ...
          echo "Low count: ${{ needs.job1.outputs.gosec-job-output-low }}"
          echo "Policy subject: ${{ needs.job1.outputs.gosec-job-output-policy-subject }}"
